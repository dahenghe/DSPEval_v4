...
DSPQC <- function(data.raw, controls, colData, Comparison.Pair, colData.grouping.index, colData.ROI.area.index, colData.ROI.nuclei.count.index=NULL, colData.Subject.index=NULL){
